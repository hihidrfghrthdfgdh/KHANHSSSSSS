...
lyr_CONG_14.set('fieldAliases', {'ID': 'ID', 'CHIỀU DÀI L': 'CHIỀU DÀI L', 'ĐƯỜNG KÍNH D': 'ĐƯỜNG KÍNH D', 'ĐỘ DỐC I%': 'ĐỘ DỐC I%', 'Q=MƯA': 'Q=MƯA', 'Q=CỐNG': 'Q=CỐNG', 'VẬN TỐC (M/S)': 'VẬN TỐC (M/S)', 'H/D (5 NĂM)': 'H/D (5 NĂM)', 'H/D (20 NĂM )': 'H/D (20 NĂM )', 'NGÀY LẮP ĐẶT': 'NGÀY LẮP ĐẶT', 'NGÀY BẢO TRÌ': 'NGÀY BẢO TRÌ', 'GHI CHÚ': 'GHI CHÚ', });
...
lyr_CONG_14.set('fieldImages', {'ID': 'TextEdit', 'CHIỀU DÀI L': 'TextEdit', 'ĐƯỜNG KÍNH D': 'TextEdit', 'ĐỘ DỐC I%': 'TextEdit', 'Q=MƯA': 'TextEdit', 'Q=CỐNG': 'TextEdit', 'VẬN TỐC (M/S)': 'TextEdit', 'H/D (5 NĂM)': 'Range', 'H/D (20 NĂM )': 'TextEdit', 'NGÀY LẮP ĐẶT': 'DateTime', 'NGÀY BẢO TRÌ': 'DateTime', 'GHI CHÚ': 'TextEdit', });
...
lyr_CONG_14.set('fieldLabels', {'ID': 'header label - always visible', 'CHIỀU DÀI L': 'header label - always visible', 'ĐƯỜNG KÍNH D': 'header label - always visible', 'ĐỘ DỐC I%': 'header label - always visible', 'Q=MƯA': 'header label - always visible', 'Q=CỐNG': 'header label - always visible', 'VẬN TỐC (M/S)': 'header label - always visible', 'H/D (5 NĂM)': 'header label - always visible', 'H/D (20 NĂM )': 'header label - always visible', 'NGÀY LẮP ĐẶT': 'header label - always visible', 'NGÀY BẢO TRÌ': 'header label - always visible', 'GHI CHÚ': 'header label - always visible', });
